...
text18.insert("insert","PureColorAvr.csv")
...
def CircleCallback(event,x,y,flags,param):
    ...
    global refPt,PtBGR,w,h,Serial,r1,r2,r3,r4,rate,rate2,rate3,r6,r7,r8,r9,add,add2,add3,A,R,G,B
    ...
    if event == cv2.EVENT_LBUTTONDOWN:
        ...
        for c in range(0,n):
            ...
            if len(refPt)==n:
                ...
                color_list=[color]
                print(color_list)
                df = pd.DataFrame(list(zip(Serial,r,g,b,r1,r2,r3,locate,brand,r4,add,rate,add2,rate2,add3,rate3,r6,r7,r8,color_list))
...
def color_def(RAvr,GAvr,BAvr,Avr):
        global color
